  ...
  return (
    <div className="flex flex-col justify-center items-center h-full w-full">
      <h1 className="text-3xl font-bold mt-10 mb-5">
        Welcome to React Concepts Workshop! :D
      </h1>
      {[
        { label: "Components", href: "/1-components" },
        { label: "Props & Interface", href: "/2-props&interface" },
        { label: "Mapping", href: "/3-mapping" },
        { label: "useState and useEffect", href: "/4-useState-and-useEffect" },
        { label: "Conditional Rendering", href: "/5-conditionalrendering" },
        { label: "Context", href: "/6-context" },
      ].map((item) => (
        <Link
          key={item.label}
          href={item.href}
